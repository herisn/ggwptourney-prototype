...
class TournamentDetail extends StatelessWidget {
  const TournamentDetail({ Key? key }) : super(key: key);
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: NetworkImage('https://i.ibb.co/8228jGm/Group-135.png'),
                  fit: BoxFit.cover,
                )
              ),
            ),
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: Colors.grey,
                              image: DecorationImage(
                                image: NetworkImage('https://i.ibb.co/ZTbM52v/Rectangle-5.png'),
                                fit: BoxFit.cover
                              ),
                          ...
                          Column(
                            ...
                            children: [
                              Text('PUBG Invitational', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),),
                              SizedBox(height: 8,),
                              Text('12 Juli - 30 Juli 2020')
                            ],
                          )
                        ],
                      ),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Icon(Icons.circle, size: 10,),
                                    SizedBox(width: 10,),
                                    Text('1 Tim Terdiri dari 5 Orang'),
                                  ],
                                ),
                                Row(
                                  children: [
